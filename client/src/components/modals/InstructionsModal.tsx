  ...
  return (
    <div className="modal" onClick={closeModal}>
      <div className="modal-content pixel-corners-grey">
        ...
        <h2>Instructions</h2>
        <h3>The Word Game</h3>
        <p>• The point of this game is to correctly guess the presented Pokémon through trial and error.</p>
        ...
        <h3>Miscellaneous</h3>
        <p>• You can navigate the menus and the page with your arrow keys, Enter, and Escape keys.</p>
